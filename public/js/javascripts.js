...
let number = 60;
const speed = 3;
const linkWidth = 0.45;
const linkDistance = 300;
const size = 2.3;
var repulseDistance = 70;
const linkDistance2 = (0.8 * linkDistance) ** 2;
const repulseDistance2 = repulseDistance ** 1.5;
Math.TAU = Math.PI * 2;
const particleStyle = "#e19158";
const linkRGB = "#e19158";
const quadStyle = "url(../img/bg-img.jpg)";
const candidates = [];
var W,H;
...
removeControl.addEventListener("click", () => editNumber(-20));
